...
function initBall() {
    ...
    xSpeed = -4;            // Flipped to -4 to avoid infite scoring
    ySpeed = 2;
}
...
function checkPaddleCollision(ball, paddle) {
    // Check if paddle and ball overlap vertical or horizontal
    return (
...
function checkCollision() {
    ...
    if (checkPaddleCollision(ball, leftPaddle)) {
        // Left paddle collision has occured
    ...
    if (checkPaddleCollision (ball, rightPaddle)) {
        // Right paddle collision has occured
...
function drawGameOver() {
    ...
    ctx.fillText("501st Tennjs: GAME OVER", width / 2, height / 2);
}
